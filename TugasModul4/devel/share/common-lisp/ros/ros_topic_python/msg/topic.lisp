...
(cl:in-package ros_topic_python-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <topic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'topic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_topic_python-msg:<topic> is deprecated: use ros_topic_python-msg:topic instead.")))

(cl:ensure-generic-function 'usia-val :lambda-list '(m))
(cl:defmethod usia-val ((m <topic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_topic_python-msg:usia-val is deprecated.  Use ros_topic_python-msg:usia instead.")
  (usia m))

(cl:ensure-generic-function 'tinggi-val :lambda-list '(m))
(cl:defmethod tinggi-val ((m <topic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_topic_python-msg:tinggi-val is deprecated.  Use ros_topic_python-msg:tinggi instead.")
  (tinggi m))

(cl:ensure-generic-function 'nama-val :lambda-list '(m))
(cl:defmethod nama-val ((m <topic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_topic_python-msg:nama-val is deprecated.  Use ros_topic_python-msg:nama instead.")
  (nama m))

(cl:ensure-generic-function 'kehadiran-val :lambda-list '(m))
(cl:defmethod kehadiran-val ((m <topic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_topic_python-msg:kehadiran-val is deprecated.  Use ros_topic_python-msg:kehadiran instead.")
  (kehadiran m))
