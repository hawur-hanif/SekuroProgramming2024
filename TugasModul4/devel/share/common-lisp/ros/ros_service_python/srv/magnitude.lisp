...
(cl:in-package ros_service_python-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <magnitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'magnitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_service_python-srv:<magnitude-request> is deprecated: use ros_service_python-srv:magnitude-request instead.")))

(cl:ensure-generic-function 'komponenX-val :lambda-list '(m))
(cl:defmethod komponenX-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_service_python-srv:komponenX-val is deprecated.  Use ros_service_python-srv:komponenX instead.")
  (komponenX m))

(cl:ensure-generic-function 'komponenY-val :lambda-list '(m))
(cl:defmethod komponenY-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_service_python-srv:komponenY-val is deprecated.  Use ros_service_python-srv:komponenY instead.")
  (komponenY m))

(cl:ensure-generic-function 'komponenZ-val :lambda-list '(m))
(cl:defmethod komponenZ-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_service_python-srv:komponenZ-val is deprecated.  Use ros_service_python-srv:komponenZ instead.")
  (komponenZ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<magnitude-request>)))
  ...
  "ros_service_python/magnitudeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'magnitude-request)))
  "Returns string type for a service object of type 'magnitude-request"
  "ros_service_python/magnitudeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <magnitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'magnitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_service_python-srv:<magnitude-response> is deprecated: use ros_service_python-srv:magnitude-response instead.")))

(cl:ensure-generic-function 'magnitude-val :lambda-list '(m))
(cl:defmethod magnitude-val ((m <magnitude-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_service_python-srv:magnitude-val is deprecated.  Use ros_service_python-srv:magnitude instead.")
  (magnitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<magnitude-response>)))
  ...
  "ros_service_python/magnitudeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'magnitude-response)))
  "Returns string type for a service object of type 'magnitude-response"
  "ros_service_python/magnitudeResponse")
